                ...
                <tbody>
                    ...
                    <tr>
                        <form method="POST">
                            ...
                            <td>
                                <input type="number" name="price" value="<?php echo htmlspecialchars($article['price']); ?>" step="0.01" min="0.01" required style="width: 100px;">
                            </td>
                            <td>
                                <input type="color" name="color" value="<?php echo htmlspecialchars($article['color'] ?? '#007bff'); ?>">
                            </td>
                            <td class="actions">
