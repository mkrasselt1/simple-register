        ...
        <div class="products-panel">
            ...
            <div class="products-grid" id="productsGrid">
                ...
                <button class="product-btn" 
                        style="background-color: <?php echo htmlspecialchars($article['color'] ?? '#007bff'); ?>"
                        data-id="<?php echo htmlspecialchars($article['id']); ?>"
                        data-name="<?php echo htmlspecialchars($article['name']); ?>"
                        data-price="<?php echo htmlspecialchars($article['price']); ?>"
                        onclick="addToCart(this)">
                    <span class="name"><?php echo htmlspecialchars($article['name']); ?></span>
