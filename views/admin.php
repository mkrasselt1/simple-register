            ...
            <form method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="price" name="price" inputmode="decimal" pattern="-?\d+(\.\d{1,2})?" required placeholder="2.50">
                    </div>
                    <div class="form-group">
                ...
                <tbody>
                    ...
                    <form method="POST">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="price" value="<?php echo View::escape($article->price); ?>" inputmode="decimal" pattern="-?\d+(\.\d{1,2})?" required style="width: 100px;"> €
                            </td>
                            <td>
